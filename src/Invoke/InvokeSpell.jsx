...
const InvokeSpell = ({ one, two, three, spell }) => {
    ...
    return (
        <div className="spell flex items-center justify-center gap-2">
            ...
            <svg className="h-2.5 lg:h-full" width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="h-2.5 lg:h-full" width="10" height="7" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
